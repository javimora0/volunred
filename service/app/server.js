...
class Server {
    constructor() {
        ...
        this.voluntariado = '/api/voluntariado'
        this.middlewares()
        this.routes()
    }
    ...
    routes() {
        ...
        this.app.use(this.usuario, require('../routes/usuarios_routes'))
        this.app.use(this.voluntariado, require('../routes/voluntariado_routes'))
